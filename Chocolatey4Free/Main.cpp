...
int main(int argc, char* argv[]) {
	...
	if ( argv[1] == NULL || argv[2] == NULL || argv[3] == NULL ) {
		...
		powershell += fmt::format("Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/0x4F776C/Setup-Guides/main/Chocolatey/files/default.nuspec' -OutFile '{0}\\{0}.nuspec'\n", packageIDName);
		...
		powershell += fmt::format("Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/0x4F776C/Setup-Guides/main/Chocolatey/files/chocolateyinstall.ps1' -OutFile '{0}\\tools\\chocolateyinstall.ps1'\n", packageIDName);
		...
		powershell += fmt::format("Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/0x4F776C/Setup-Guides/main/Chocolatey/files/chocolateyuninstall.ps1' -OutFile '{0}\\tools\\chocolateyuninstall.ps1'\n", packageIDName);
